...
<div className="screenshot-pair">
  <img className="screenshot--light" src="/img/light/map.png" alt="Interactive Map editor in the light theme" />
  <img className="screenshot--dark" src="/img/dark/map.png" alt="Interactive Map editor in the dark theme" />
</div>